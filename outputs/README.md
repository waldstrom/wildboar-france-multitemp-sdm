...
This directory is intentionally empty in version control. Pipeline runs may create models, maps, figures, response curves, statistics, logs, cached predictor stacks and other derived products here.
